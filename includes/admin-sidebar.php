...
<nav>
    <ul class="metismenu" id="menu">
        ...
        <li class="<?php if($page=='designation') {echo 'active';} ?>"><a href="designation.php"><i class="fa fa-th-large"></i> <span>Designation Section</span></a></li>
        <li class="<?php if($page=='payroll') {echo 'active';} ?>"><a href="payroll.php"><i class="fa  fa-money"></i> <span>Payroll Section</span></a></li>
        
        <!-- Only show these sections for admin users -->
        <?php if ($_SESSION['usertype'] === 'Admin') { ?>
            <li class="<?php if($page=='site') {echo 'active';} ?>"><a href="site.php"><i class="fa fa-th-large"></i> <span>Site Section</span></a></li>

            <li class="<?php if($page=='supplier') {echo 'active';} ?>"><a href="supplier.php"><i class="fa  fa-money"></i> <span>Supplier Section</span></a></li>
