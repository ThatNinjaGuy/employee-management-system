<?php
    ...
    if(isset($_POST['update'])){
        ...
        $did=intval($_GET['supid']);    
        $name=$_POST['name'];
     
         
        $sql="UPDATE tblsupplier set name=:name where id=:did";
                        ...
                        <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                                ...
                                <form method="POST">
                                 <div class="card-body">
                                        ...
                                        <p class="text-muted font-14 mb-4">Please make changes on the form below in order to update supplier</p>

                                        <?php 
                                            $did=intval($_GET['supid']);
                                            $sql = "SELECT * from tblsupplier WHERE id=:did";
                                            $query = $dbh -> prepare($sql);
                                            $query->bindParam(':did',$did,PDO::PARAM_STR);
                                            $query->execute();
