<?php
    ...
    $sql="INSERT INTO admin(fullname,email,Password,UserName,usertype) VALUES(:fullname,:email,:password,:username,:usertype)";
                            ...
                            <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                                ...
                                <form name="addemp" method="POST">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                        <label for="example-select" class="col-form-label">User Type</label>
                                        <select class="form-control" id="example-select" name="usertype">
