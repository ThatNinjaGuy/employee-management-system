...
<body>
    ...
    <img src="../assets/images/icon/ar2.jpeg" alt="logo" style="width: 60px; height: auto;">
        ...
        <div class="main-content">
            <?php
                $pageTitle = "Update Payslip";
                $homeLink = "payroll.php";
                $breadcrumb = "Update Payslip";
                $homeText = "Payslip";
    ...
    <div class="form-group">
        ...
        <input class="form-control" name="rateDisplay" type="text" required id="rateDisplay" readonly value="<?php echo htmlentities($result->rateDisplay); ?> ">
    </div>
    <div class="form-group">
        <label for="daysWorked" class="col-form-label">Days Worked</label>
        <input class="form-control" name="daysWorked" type="text" required id="daysWorked" value="<?php echo htmlentities($result->daysWorked); ?>" oninput="calculateTotalAmount()">
    </div>
    <div class="form-group">
        <label for="overTime" class="col-form-label">Over Time</label>
        <input class="form-control" name="overTime" type="text" required id="overTime" value="<?php echo htmlentities($result->overTime); ?>" oninput="calculateTotalAmount()">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input class="form-control" name="advance_in_site" type="text" required id="advance_in_site" value="<?php echo htmlentities($result->advance_in_site); ?>" oninput="calculateTotalAmount()">
    </div>
    <div class="form-group">
        <label for="advance_in_home" class="col-form-label">Advance in Home</label>
        <input class="form-control" name="advance_in_home" type="text" required id="advance_in_home" value="<?php echo htmlentities($result->advance_in_home); ?>" oninput="calculateTotalAmount()">
    </div>
    <div class="form-group">
        <label for="mess" class="col-form-label">Mess</label>
        <input class="form-control" name="mess" type="text" required id="mess" value="<?php echo htmlentities($result->mess); ?>" oninput="calculateTotalAmount()">
    </div>
    <div class="form-group">
        <label for="sunday_expenditure" class="col-form-label">Sunday Expenditure</label>
        <input class="form-control" name="sunday_expenditure" type="text" required id="sunday_expenditure" value="<?php echo htmlentities($result->sunday_expenditure); ?>" oninput="calculateTotalAmount()">
    </div>
    <div class="form-group">
        <label for="penalty" class="col-form-label">Penalty</label>
        <input class="form-control" name="penalty" type="text" required id="penalty" value="<?php echo htmlentities($result->penalty); ?>" oninput="calculateTotalAmount()">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
            ...
            <input type="hidden" class="form-control"  name="CreationDate" type="text" required id="CreationDate" value="<?php echo htmlentities($result->CreationDate); ?>">
        </div>
        <div class="form-group">
            <label for="payrollMonth" class="col-form-label"></label>
            <input type="hidden" class="form-control" name="payrollMonth" type="text" required id="payrollMonth" value="<?php echo htmlentities($result->payrollMonth); ?>">
        </div>
