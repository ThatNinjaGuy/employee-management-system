<?php
    ...
    $name=$_POST['name']; 
    $sql="INSERT INTO tblsupplier(name) VALUES(:name)";
                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                <li><a href="department.php">Supplier</a></li>
                                <li><span>Add</span></li>
                        ...
                        <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                                ...
                                <form method="POST">
                                 <div class="card-body">
                                        ...
                                        <p class="text-muted font-14 mb-4">Please fill up the form in order to add new designation</p>
