<?php
    ...
    $query -> execute();
    $msg="The selected attendance has been deleted";
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Attendance Section</h4>
                    ...
                    <div class="col-12 mt-5">
                        ...
                        <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                            ...
                            <div class="card-body">
                                ...
                                <center><a href="add-attendance.php" class="btn btn-sm btn-info">Add New Attendance</a></center>
                                    <table id="dataTable3" class="table table-hover table-striped text-center">
                                        <thead class="text-capitalize"  style="background-color: #212529;">
                                            <tr>
                                                <th>#</th>
...
if ($query->rowCount() > 0) {
    foreach ($results as $result) { ?>
        <tr>
            ...
            <td><?php echo htmlentities($result->daysWorked); ?></td>
            <td><?php echo htmlentities($result->startDate); ?></td>
            <td><?php echo htmlentities($result->endDate); ?></td>
            <td><?php echo htmlentities($result->created_at); ?></td>
            <td>
                <a href="edit-attendance.php?attid=<?php echo htmlentities($result->id); ?>">
                    <i class="fa fa-edit" style="color:green"></i>
                </a>
                <a href="attendance.php?del=<?php echo htmlentities($result->id); ?>" 
